...
<!--                    <a href=""><i class='bx bxl-whatsapp'></i></a>-->
            ...
            <div class="home-sec-img">
                <img src="Gallery/My_Pic_1.png" alt="">
            </div>
</section>
<hr class="hr1">
                ...
                <div class="contact-info-content">
                    ...
                    <form action="form-handler.php" method="post">
                            <div class="form-input">
                                    <input type="text" placeholder="Enter Your Name" name="name" id="contact-name" onkeyup="validateName()">
                                        <span id="name-error"></span>
                                    </div>
                                    <div class="form-input">
                                    <input type="text" placeholder="Enter Your Email Address" name="email" id="contact-email" onkeyup="validateEmail()">
                                        <span id="email-error"></span>
                                    </div>
                                    <div class="form-input message-box">
                                    <textarea placeholder="Type Your Message Here!" name="message" id="contact-message" onkeyup="validateMessage()"></textarea>
                                        <span id="message-error"></span>
                                    </div>
                            <div class="form-button">
                            <input type="button" value="Send Message" name="submit" onclick="return validateForm()">
    ...
    <script>
        ...
        function validateName() {
            ...
            if(!name.match(/^[A-Za-z]*\s{1}[A-Za-z]*$/)) {
                nameError.innerHTML = 'Enter Your Full Names';
                return false;
            }
        ...
        function validateForm() {
            if(!validateName() || !validateEmail() || !validateMessage()) {
                ...
                submitError.innerHTML = 'Empty Fields! *Required';
